---
title: "Getting actionable satisfaction survey results"
date: "`r Sys.Date()`"
output:
  prettydoc::html_pretty:
    ...
    highlight: github
vignette: >
  %\VignetteIndexEntry{Getting actionable satisfaction survey results}
...
The services provided by the companies are classified into one of 4 categories, according to the way in which they affect satisfaction:
...
In the second part, every respondent is requested to evaluate the service criteria on a 5 points semantic-differential scale. Crteria can include: 

 * Accessibility: Signs to reach the center, Car Park, Quickness, Security, Getting a convenient appointment
 * Availability: Clear indication of opening hours, Punctuality, Call me back 
 * Appropriateness: Clear Explanations, cultural sensitivity, Cleanliness
 * Responsiveness : Information on waiting time,  Availability of seats 
 * Reliability: Technical competences  
 * Empathy: Listening capacities,   
 * Professionalism:  Patience, Politeness
